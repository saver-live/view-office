...
public class JacobWordTool {
	...
	public JacobWordTool(boolean visible) throws Exception {  
     ...
     * @param htmlPath
     */
    public void saveAsHtml(String pdfPath) {
        Dispatch.invoke(doc, "SaveAs", Dispatch.Method, new Object[] {
                pdfPath, new Variant(8) }, new int[1]);
    }
     ...
     * @param htmlPath 
     */  
    public void saveAsdocx(String pdfPath) {  
        Dispatch.invoke(doc, "SaveAs", Dispatch.Method, new Object[] {  
                pdfPath, new Variant(16) }, new int[1]);  
    }  
    ...
    */
    ...
    public String[] getBookMarks() {  
        ...
        ArrayList lstBookMarks = new ArrayList();
        int MarksCount = Dispatch.get(bookMarks, "Count").getInt();
        bookMarkList= new String[MarksCount];
